...
import static Aplicação.ProjetoPOO.agropecuarios;
import javax.swing.JOptionPane;


public class LoginAgro extends javax.swing.JFrame {
    ...
    public void loginA(String email,String senha)
    {        
        
        Agropecuario ap = pesquisarA(email);
            if(ap == null){
                JOptionPane.showMessageDialog(null,"Email inexistente");
         }else{
              if(ap.getSenha().equals(senha)){
                   JOptionPane.showMessageDialog(null,"Seja bem vindo "+ap.getRazao_Social());
    ...
    public static Agropecuario pesquisarA(String email)
    {
    ...
    private void initComponents() {
        ...
        titulo.setFont(new java.awt.Font("Microsoft Sans Serif", 1, 36)); // NOI18N
        titulo.setForeground(new java.awt.Color(255, 255, 255));
        titulo.setText("Login Agropecuário");
        getContentPane().add(titulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 70, -1, -1));
        ...
        jPanel1.add(jredefinir, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 250, -1, -1));
        ...
        jPanel1.add(jcadastrese, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 430, -1, -1));
    ...
    private void jredefinirMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jredefinirMouseClicked
        RecuperarSenhaAP(jMail.getText());
    }//GEN-LAST:event_jredefinirMouseClicked

    private void bEntrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bEntrarActionPerformed
        loginA(jMail.getText(),jSenha.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoginAgro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
